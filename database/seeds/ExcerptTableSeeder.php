...
class ExcerptTableSeeder extends Seeder
{
    ...
    public function run()
    {
        return [
            ...
            /* Robespierre */
            Excerpt::create(['content' => 'The secret of freedom lies in educating people, whereas the secret of tyranny is in keeping people ignorant.', 'author' => 'Maximilien Robespierre']),
            
            /* Roosevelt */
            Excerpt::create(['content' => 'Men are not prisoners of fate, but only prisoners of their own minds.', 'author' => 'Franklin D. Roosevelt']),
            
            /* Rumi */
            Excerpt::create(['content' => 'Yesterday I was clever, so I wanted to change the world. Today I am wise, so I am changing myself.', 'author' => 'Jalal ad-Din Rumi']),
            
            /* Santayana */
            Excerpt::create(['content' => 'Those who cannot remember the past are condemned to repeat it.', 'author' => 'George Santayana']),

            /* Schneider */
            Excerpt::create(['content' => 'Our patriot movement in these United States is going to pick up the ball, and we are going to kick the parasites out.', 'author' => 'Philip Schneider']),
