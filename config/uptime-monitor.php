...
return [
    ...
    'notifications' => [
         ...
         */
        'location' => 'HumanitysTruth Uptime Monitor',
    ...
    'uptime_check' => [
         ...
         */
        'retry_connection_after_milliseconds' => 200,
         ...
         */
        'fire_monitor_failed_event_after_consecutive_failures' => 5,

        /*
         * When reaching out to sites this user agent will be used.
         */
        'user_agent' => 'humanitystruth uptime monitor',
